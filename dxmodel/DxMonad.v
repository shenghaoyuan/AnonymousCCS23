...
Definition eval_pc: M int := rBPFMonadOp.eval_pc.
...
Definition eval_ins_len : M int := rBPFMonadOp.eval_ins_len.

(**r here we must use sint32_t instead of int because pc is signed int *)
Definition eval_ins (idx: int) : M int64 := rBPFMonadOp.eval_ins idx.
