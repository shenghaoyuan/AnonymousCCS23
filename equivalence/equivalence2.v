...
Ltac unfold_dx_type :=
  ...
  | |- _ =>
    ...
    unfold DxIntegers.sint32_t, DxNat.nat8, DxValues.val64_t, DxValues.valu32_t, DxValues.vals32_t;
  unfold_monad
  end.
...
Ltac unfold_dx_name :=
  match goal with
  | |- _ =>
    unfold DxNat.nat8_zero, DxNat.nat8_0x08, DxNat.nat8_0x07, DxIntegers.int64_0xff, DxIntegers.int64_32, DxNat.nat8_0xf0, DxIntegers.int64_64, DxValues.val32_64, DxIntegers.int64_48, DxNat.nat8_0xff, DxValues.val64_zero, Regs.val64_zero, DxIntegers.int32_64
  end.
...
Proof.
  ...
  unfold DxMonad.int64_to_dst_reg, DxNat.nat2int, DxIntegers.int32_8, DxValues.Val_ulongofslong, DxValues.Val_slongofint, DxMonad.int64_to_src_reg, DxInstructions.get_opcode_alu64, DxInstructions.reg64_to_reg32, DxNat.nat8_0x87, DxInstructions.step_opcode_alu32, DxInstructions.get_offset, DxInstructions.step_opcode_branch, DxIntegers.int32_32, DxInstructions.step_opcode_mem_ld_reg, DxInstructions.step_opcode_mem_ld_imm, DxInstructions.step_opcode_mem_st_reg, DxInstructions.step_opcode_mem_st_imm, DxInstructions.get_addr_ofs.
  destruct_if_reflexivity.
  destruct State.eval_ins; [| reflexivity].
  destruct int64_to_dst_reg; [| reflexivity].
  destruct p.
  destruct (match
    Nat.land
      (Z.to_nat (Int64.unsigned (Int64.and _ (Int64.repr 255))))
      7
  with
