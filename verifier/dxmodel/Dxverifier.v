...
Definition is_dst_R0 (i: int64) : M bool := returnM (is_dst_R0' i).

Definition is_well_dst (i: int64) : M bool := returnM (is_well_dst' i).

Definition is_well_src (i: int64) : M bool := returnM (is_well_src' i).

Definition is_well_jump (pc len: nat) (ofs: sint32_t) : M bool := returnM (is_well_jump' pc len ofs).

Definition is_not_div_by_zero (i: int64) : M bool := returnM (is_not_div_by_zero' i).

Definition is_not_div_by_zero64 (i: int64) : M bool := returnM (is_not_div_by_zero64' i).

Definition is_shift_range (i: int64) (upper: int): M bool := returnM (is_shift_range' i upper).

Definition is_shift_range64 (i: int64) (upper: int): M bool := returnM (is_shift_range64' i upper).

Definition get_opcode (ins: int64): M nat8 := returnM (get_opcode ins).

Definition get_offset (i: int64): M sint32_t := returnM (get_offset i).

Definition bpf_verifier_opcode_alu32_imm (op: nat8) (ins: int64) : M bool :=
...
Definition bpf_verifier_opcode_alu32_reg (op: nat8) (ins: int64) : M bool :=
...
Definition bpf_verifier_opcode_alu64_imm (op: nat8) (ins: int64) : M bool :=
...
Definition bpf_verifier_opcode_alu64_reg (op: nat8) (ins: int64) : M bool :=
...
Definition bpf_verifier_opcode_branch_imm (pc len: nat) (op: nat8) (ins: int64) : M bool :=
...
Definition bpf_verifier_opcode_branch_reg (pc len: nat) (op: nat8) (ins: int64) : M bool :=
...
Definition bpf_verifier_opcode_load_imm (op: nat8) (ins: int64) : M bool :=
...
Definition bpf_verifier_opcode_load_reg (op: nat8) (ins: int64) : M bool :=
...
Definition bpf_verifier_opcode_store_imm (op: nat8) (ins: int64) : M bool :=
...
Definition bpf_verifier_opcode_store_reg (op: nat8) (ins: int64) : M bool :=
...
Definition bpf_verifier_aux2 (pc len: nat) (op: nat8) (ins: int64) : M bool :=
