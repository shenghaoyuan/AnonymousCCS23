...
Proof.
  ...
  apply Cle_Zle_iff in Hlow as Hlow'.

  unfold Int.add in Hlow'.
  rewrite unsigned_repr_size_chunk in Hlow'.
  rewrite Int.unsigned_repr in Hlow'; [| assumption].
  ...
  split.
  eapply range_perm_included_leq; eauto.
