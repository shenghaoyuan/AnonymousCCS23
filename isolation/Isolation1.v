...
Proof.
  ...
  destruct State.eval_ins; [| inversion Hsem].
  ...
  - (* BPF_CALL *)
    assert (Hget_call := lemma_bpf_get_call).
    specialize (Hget_call (Int.repr (Int64.unsigned (Int64.repr (Int.signed i0)))) st1).
    ...
    + destruct Val.cmpu_bool eqn:cmp; [| inversion Hsem].
      ...
      * inversion Hsem; split; [eapply reg_inv_upd_flag; eauto |
          split; [eapply mem_inv_upd_flag; eauto | eapply state_include_upd_flag; eauto]].
      * assert (Hexec := lemma_exec_function0).
