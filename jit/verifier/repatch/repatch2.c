...
const char old_words[][200] = {
	...
	"int get_offset",
	"_Bool jit_verifier_opcode_alu32_imm",
	"_Bool jit_verifier_opcode_alu32_reg",
	...
	"_Bool jit_verifier_aux2(",
	"eval_ins_len()",
	"eval_ins(",
	"_Bool jit_verifier_aux(",
	"_Bool jit_verifier(void)",
	"return jit_verifier_aux(",
	"= jit_verifier_aux("
	
	};

const char new_words[][200] = {
	"static __attribute__((always_inline)) inline _Bool is_compcert_udiv",
	...
	"static __attribute__((always_inline)) inline _Bool jit_verifier_opcode_alu32_imm",
	"static __attribute__((always_inline)) inline _Bool jit_verifier_opcode_alu32_reg",
	...
	"static __attribute__((always_inline)) inline _Bool jit_verifier_aux2(",
	"eval_ins_len(st)",
	"eval_ins(st, ",
	"_Bool jit_verifier_aux(struct verifier_state * st, ",
	"_Bool jit_verifier(struct verifier_state * st)",
	"return jit_verifier_aux(st, ",
	"= jit_verifier_aux(st, "
