...
```shell
# assume your ubuntu is named `shyuan`
# current folder: /home/shyuan/CertrBPF
...
#  ==> ./home/shyuan/.opam
# 2); adding the line: `export PATH=$PATH:/home/shyuan/.opam/bpf/bin:/home/shyuan/CertrBPF/coq2html`
...
vim /home/shyuan/.bashrc
source /home/shyuan/.bashrc
```
...
# Build CertrBPF
```shell
# current folder: /home/shyuan/CertrBPF/dx
# install CertrBPF
cd ..
git clone --branch middelware https://github.com/future-proof-iot/CertFC.git
cd CertFC
# when using opam to install compcert
./configure --opamprefixdir=/home/shyuan/.opam/bpf
# modify the file `_CoqProject`:
# -R /home/shyuan/.opam/bpf/lib/coq-variant/compcert32/compcert compcert
vim _CoqProject

# modify the file `Makefile.config`:
# DXDIR := /home/shyuan/.opam/bpf/lib/dx
# COMPCERTDIR := /home/shyuan/.opam/bpf/lib/coq-variant/compcert32/compcert
# CLIGHTGEN32DIR := /home/shyuan/.opam/bpf/variants/compcert32/bin
# COMPCERTSRCDIR := /home/shyuan/.opam/bpf/.opam-switch/build/coq-compcert-32.3.11
vim Makefile.config

# when using source code
./configure --opamprefixdir=/home/shyuan/.opam/bpf --compcertdir=YOUR_COMPCERT_DIR/compcert

make all
```
# Test CertrBPF 
```shell
# current folder: /home/shyuan/CertrBPF/CertFC
