...
Inductive bpf_instruction: Type :=
  (**r ALU64/32*)
  | BPF_NEG    : arch -> reg -> bpf_instruction
  | BPF_BINARY : arch -> binOp -> reg -> reg+imm -> bpf_instruction
  (**r Branch *)
  | BPF_JA   : off -> bpf_instruction
  | BPF_JUMP : cond -> reg -> reg+imm -> off -> bpf_instruction

  (**r Load *)
  | BPF_LDDW_low : reg -> imm -> bpf_instruction
  | BPF_LDDW_high : reg -> imm -> bpf_instruction
  (**r Load_x *)
