...
Definition get_instruction_alu64_imm (ins: int64) (rd: reg) (i: int) (op: nat): bpf_instruction :=
  match op with
  (*ALU64_imm *)
...
Definition get_instruction_alu64_reg (ins: int64) (rd rs: reg) (op: nat): bpf_instruction :=
  match op with
  (*ALU64_reg *)
...
Definition get_instruction_ld (ins: int64) (rd: reg) (i: int) (op: nat): bpf_instruction :=
...
Fixpoint decode_prog_aux (fuel pc: nat) (l: List64AsArray.t): list bpf_instruction :=
  ...
  | O => []
  | S n =>
    match List64AsArray.index l (Int.repr (Z.of_nat pc)) with
    | Some i =>
      match decode i with
