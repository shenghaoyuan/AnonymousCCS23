...
Definition bpf64_to_binary (ins: bpf_instruction): int64 :=
  ...
  | BPF_NEG a dst =>
    let dst64 := Int64.repr (id_of_reg dst) in
      match a with
      | A32 => encode_bpf64 dst64 (Int64.repr 0x84) 8 4
      | A64 => encode_bpf64 dst64 (Int64.repr 0x87) 8 4
      end
  ...
  | BPF_LDDW_low dst i =>
    let dst64 := Int64.repr (id_of_reg dst) in
    let imm64 := Int64.repr (Int.signed i) in
    let ins_dst := encode_bpf64 dst64 (Int64.repr 0x18) 8 4 in
      encode_bpf64 imm64 ins_dst 32 32
  | BPF_LDDW_high dst i =>
    let dst64 := Int64.repr (id_of_reg dst) in
    let imm64 := Int64.repr (Int.signed i) in
    let ins_dst := encode_bpf64 dst64 (Int64.repr 0x10) 8 4 in
      encode_bpf64 imm64 ins_dst 32 32
